...
def to_setup_signal(
    ...
    *,
    ...
    return SetupSignal(
        ...
        rank_components=(
            RankComponents.model_validate(candidate.rank_components)
            if candidate.rank_components
            else None
        ),
        category=candidate.asset_class.value if candidate.asset_class is not None else None,
    )
