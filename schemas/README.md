...
|---|---|---|
| `GET /v1/universe/top?limit=10\|20` | [`universe_top.schema.json`](universe_top.schema.json) | DE ranked book. Quant: limit=10 → P0 ensemble, limit=20 → categorized + history. Provisional until `DE_API_BASE` is up. |
